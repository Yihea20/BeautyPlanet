...
namespace BeautyPlanet.Migrations
{
    ...
    [Migration("20240511213804_ProductColorSize")]
    partial class ProductColorSize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyPlanet.Models.ProductColorSize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d704ce12-6123-449d-8aca-d217afab17c6",
                            Name = "user",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "b4f3a283-5ceb-4657-93a6-496d15fd61ef",
                            Name = "manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "2dc3f74f-fc96-4990-85e6-68da7218f608",
                            Name = "employee",
            ...
            modelBuilder.Entity("BeautyPlanet.Models.ProductColorSize", b =>
                {
                    ...
                    b.HasOne("BeautyPlanet.Models.ShoppingCart", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("BeautyPlanet.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("BeautyPlanet.Models.ProductCenter", null)
            ...
            modelBuilder.Entity("ColorsProduct", b =>
                {
                    b.HasOne("BeautyPlanet.Models.Colors", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductSizes", b =>
                {
                    ...
                    b.HasOne("BeautyPlanet.Models.Sizes", null)
                        .WithMany()
