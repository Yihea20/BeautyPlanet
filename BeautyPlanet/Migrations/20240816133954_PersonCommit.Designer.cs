...
namespace BeautyPlanet.Migrations
{
    ...
    [Migration("20240816133954_PersonCommit")]
    partial class PersonCommit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "da5f5ae4-d0ac-4373-a647-d2d9f30f521f",
                            Name = "user",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "9b8bc817-adb2-4bf4-b92d-c33414de81fe",
                            Name = "manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "f7427e09-1529-4446-909d-9e716c227943",
                            Name = "employee",
            ...
            modelBuilder.Entity("BeautyPlanet.Models.Comment", b =>
                {
                    b.HasOne("BeautyPlanet.Models.Admin", null)
                        .WithMany("Comments")
                        .HasForeignKey("AdminId");
